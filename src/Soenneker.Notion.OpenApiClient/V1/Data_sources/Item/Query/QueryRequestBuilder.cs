...
{
    /// <summary>
    /// Builds and executes requests for operations under \v1\data_sources\{dataSourceId}\query
    /// </summary>
    ...
    public partial class QueryRequestBuilder : BaseRequestBuilder
    {
        ...
        public QueryRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/data_sources/{dataSourceId}/query{?filter_properties*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Notion.OpenApiClient.V1.Data_sources.Item.Query.QueryRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public QueryRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/data_sources/{dataSourceId}/query{?filter_properties*}", rawUrl)
        {
        }
        /// <summary>
        /// Query a data source
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Notion.OpenApiClient.Models.PostDatabaseQueryRequest body, Action<RequestConfiguration<global::Soenneker.Notion.OpenApiClient.V1.Data_sources.Item.Query.QueryRequestBuilder.QueryRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Notion.OpenApiClient.Models.PostDatabaseQueryRequest body, Action<RequestConfiguration<global::Soenneker.Notion.OpenApiClient.V1.Data_sources.Item.Query.QueryRequestBuilder.QueryRequestBuilderPostQueryParameters>> requestConfiguration = default)
