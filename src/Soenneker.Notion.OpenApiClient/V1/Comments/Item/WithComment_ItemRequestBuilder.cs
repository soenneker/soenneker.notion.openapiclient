...
#nullable enable
        public async Task<global::Soenneker.Notion.OpenApiClient.V1.Comments.Item.WithComment_ItemRequestBuilder.WithComment_GetResponse?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Notion.OpenApiClient.V1.Comments.Item.WithComment_ItemRequestBuilder.WithComment_GetResponse> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
