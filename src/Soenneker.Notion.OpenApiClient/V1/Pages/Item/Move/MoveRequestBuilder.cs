...
{
    /// <summary>
    /// Builds and executes requests for operations under \v1\pages\{pageId}\move
    /// </summary>
    ...
    public partial class MoveRequestBuilder : BaseRequestBuilder
    {
        ...
        public MoveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/pages/{pageId}/move", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Notion.OpenApiClient.V1.Pages.Item.Move.MoveRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MoveRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/pages/{pageId}/move", rawUrl)
        {
        }
        /// <summary>
        /// Move a page
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Notion.OpenApiClient.Models.MovePage200Response"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Notion.OpenApiClient.Models.MovePage200Response?> PostAsync(global::Soenneker.Notion.OpenApiClient.Models.MovePageRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Notion.OpenApiClient.Models.MovePage200Response> PostAsync(global::Soenneker.Notion.OpenApiClient.Models.MovePageRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Notion.OpenApiClient.Models.MovePage200Response>(requestInfo, global::Soenneker.Notion.OpenApiClient.Models.MovePage200Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Move a page
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Notion.OpenApiClient.Models.MovePageRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Notion.OpenApiClient.Models.MovePageRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
