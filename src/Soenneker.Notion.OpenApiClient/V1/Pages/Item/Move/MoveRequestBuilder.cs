...
namespace Soenneker.Notion.OpenApiClient.V1.Pages.Item.Move
{
    ...
    public partial class MoveRequestBuilder : BaseRequestBuilder
    {
        ...
        /// Move a page
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Notion.OpenApiClient.Models.MovePage200"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Notion.OpenApiClient.Models.MovePage200?> PostAsync(global::Soenneker.Notion.OpenApiClient.Models.MovePage body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Notion.OpenApiClient.Models.MovePage200> PostAsync(global::Soenneker.Notion.OpenApiClient.Models.MovePage body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Notion.OpenApiClient.Models.MovePage200>(requestInfo, global::Soenneker.Notion.OpenApiClient.Models.MovePage200.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Move a page
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Notion.OpenApiClient.Models.MovePage body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Notion.OpenApiClient.Models.MovePage body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
