...
using Soenneker.Notion.OpenApiClient.V1.Views.Item.Queries.Item;
...
namespace Soenneker.Notion.OpenApiClient.V1.Views.Item.Queries
{
    ...
    public partial class QueriesRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Notion.OpenApiClient.V1.Views.Item.Queries.QueriesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Soenneker.Notion.OpenApiClient.Models.ViewQueryResponse?> PostAsync(global::Soenneker.Notion.OpenApiClient.Models.CreateViewQueryRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Notion.OpenApiClient.Models.ViewQueryResponse> PostAsync(global::Soenneker.Notion.OpenApiClient.Models.CreateViewQueryRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Notion.OpenApiClient.Models.ViewQueryResponse>(requestInfo, global::Soenneker.Notion.OpenApiClient.Models.ViewQueryResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Create a view query
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Notion.OpenApiClient.Models.CreateViewQueryRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Notion.OpenApiClient.Models.CreateViewQueryRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Notion.OpenApiClient.V1.Views.Item.Queries.QueriesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Notion.OpenApiClient.V1.Views.Item.Queries.QueriesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Notion.OpenApiClient.V1.Views.Item.Queries.QueriesRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
