...
#nullable enable
        public async Task<global::Soenneker.Notion.OpenApiClient.Models.PageOrDataSourceResponseApplicationJson?> PostAsync(global::Soenneker.Notion.OpenApiClient.Models.PostSearch body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Notion.OpenApiClient.Models.PageOrDataSourceResponseApplicationJson> PostAsync(global::Soenneker.Notion.OpenApiClient.Models.PostSearch body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Notion.OpenApiClient.Models.PageOrDataSourceResponseApplicationJson>(requestInfo, global::Soenneker.Notion.OpenApiClient.Models.PageOrDataSourceResponseApplicationJson.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Search by title
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Notion.OpenApiClient.Models.PostSearch body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Notion.OpenApiClient.Models.PostSearch body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
