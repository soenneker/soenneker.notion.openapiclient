...
namespace Soenneker.Notion.OpenApiClient.Models
{
    ...
    public partial class RetrieveADataSource200 : IComposedTypeWrapper, IParsable
    {
...
#nullable restore
        ...
        public static global::Soenneker.Notion.OpenApiClient.Models.RetrieveADataSource200 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            var mappingValue = parseNode.GetChildNode("type")?.GetStringValue();
            var result = new global::Soenneker.Notion.OpenApiClient.Models.RetrieveADataSource200();
