...
namespace Soenneker.Notion.OpenApiClient.Models
{
    ...
    public partial class MovePage200 : IComposedTypeWrapper, IParsable
    {
...
#nullable restore
        ...
        public static global::Soenneker.Notion.OpenApiClient.Models.MovePage200 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            var mappingValue = parseNode.GetChildNode("type")?.GetStringValue();
            var result = new global::Soenneker.Notion.OpenApiClient.Models.MovePage200();
