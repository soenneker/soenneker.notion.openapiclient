...
namespace Soenneker.Notion.OpenApiClient.Models
{
    ...
    public partial class QuerySessionEventsRequestFilterAndItemOrItemOrItemTimestamp : IParsable
    #pragma warning restore CS1591
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Notion.OpenApiClient.Models.QuerySessionEventsRequestFilterAndItemOrItemOrItemTimestamp"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Notion.OpenApiClient.Models.QuerySessionEventsRequestFilterAndItemOrItemOrItemTimestamp CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Notion.OpenApiClient.Models.QuerySessionEventsRequestFilterAndItemOrItemOrItemTimestamp();
        }
        /// <summary>
