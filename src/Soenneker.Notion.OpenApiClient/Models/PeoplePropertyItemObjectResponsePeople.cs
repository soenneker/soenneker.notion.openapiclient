...
namespace Soenneker.Notion.OpenApiClient.Models
{
    ...
    public partial class PeoplePropertyItemObjectResponsePeople : IComposedTypeWrapper, IParsable
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Notion.OpenApiClient.Models.PeoplePropertyItemObjectResponsePeople"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Notion.OpenApiClient.Models.PeoplePropertyItemObjectResponsePeople CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            var result = new global::Soenneker.Notion.OpenApiClient.Models.PeoplePropertyItemObjectResponsePeople();
