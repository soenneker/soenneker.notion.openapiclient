...
namespace Soenneker.Notion.OpenApiClient.Models
{
    ...
    public partial class QueryMeetingNotes200_results : IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Notion.OpenApiClient.Models.QueryMeetingNotes200_results_meeting_notes? MeetingNotes { get; set; }
#nullable restore
#else
        public global::Soenneker.Notion.OpenApiClient.Models.QueryMeetingNotes200_results_meeting_notes MeetingNotes { get; set; }
#endif
        /// <summary>Always &quot;block&quot;.</summary>
        public global::Soenneker.Notion.OpenApiClient.Models.QueryMeetingNotes200_results_object? Object { get; set; }
        /// <summary>Always &quot;meeting_notes&quot;.</summary>
        public global::Soenneker.Notion.OpenApiClient.Models.QueryMeetingNotes200_results_type? Type { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Notion.OpenApiClient.Models.QueryMeetingNotes200_results"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Notion.OpenApiClient.Models.QueryMeetingNotes200_results CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Notion.OpenApiClient.Models.QueryMeetingNotes200_results();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "meeting_notes", n => { MeetingNotes = n.GetObjectValue<global::Soenneker.Notion.OpenApiClient.Models.QueryMeetingNotes200_results_meeting_notes>(global::Soenneker.Notion.OpenApiClient.Models.QueryMeetingNotes200_results_meeting_notes.CreateFromDiscriminatorValue); } },
                { "object", n => { Object = n.GetEnumValue<global::Soenneker.Notion.OpenApiClient.Models.QueryMeetingNotes200_results_object>(); } },
                { "type", n => { Type = n.GetEnumValue<global::Soenneker.Notion.OpenApiClient.Models.QueryMeetingNotes200_results_type>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.Notion.OpenApiClient.Models.QueryMeetingNotes200_results_meeting_notes>("meeting_notes", MeetingNotes);
            writer.WriteEnumValue<global::Soenneker.Notion.OpenApiClient.Models.QueryMeetingNotes200_results_object>("object", Object);
            writer.WriteEnumValue<global::Soenneker.Notion.OpenApiClient.Models.QueryMeetingNotes200_results_type>("type", Type);
        }
    }
}
